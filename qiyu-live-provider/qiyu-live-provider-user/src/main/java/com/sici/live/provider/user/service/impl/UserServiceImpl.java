...
import com.sici.live.provider.user.service.UserService;
import com.sici.live.provider.user.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserPO> implements UserService {
    ...
    public ResponseResult removeUser(UserDTO userDTO) {
        ...
        // 延迟双删
        deleteUserInfoCache(ConvertBeanUtil.convertSingle(userDTO, UserVO.class));
    ...
    private void deleteUserInfoCache(UserVO userVo) {
        // 延迟双删
